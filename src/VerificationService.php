...
namespace Esca7a\Verification;

use Carbon\Carbon;
use Esca7a\Verification\Actions\SendAction;
use Esca7a\Verification\Actions\VerifyAction;
use Esca7a\Verification\Channels\VerificationChannelContract;
use Esca7a\Verification\Exceptions\VerificationStrictTypesChannelException;
use Esca7a\Verification\Exceptions\VerificationStrictTypesVerifyValueException;
use Esca7a\Verification\Repositories\RepositoryInterface;
